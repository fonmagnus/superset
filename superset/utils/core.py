...
def pessimistic_connection_handling(some_engine: Engine) -> None:
    # Enable pool-level pre-ping to verify connections before checkout.
    # This replaces the deprecated SA 1.x 'engine_connect' event listener
    # that relied on a 'branch' parameter and connection.should_close_with_result,
    # both of which were removed in SQLAlchemy 2.0.
    some_engine.pool._pre_ping = True  # equivalent to pool_pre_ping=True
